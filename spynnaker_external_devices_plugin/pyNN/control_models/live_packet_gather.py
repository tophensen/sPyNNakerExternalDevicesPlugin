...
class LivePacketGather(
    ...
    def __init__(self, machine_time_step, timescale_factor,
                 tag, port, address, board_address, strip_sdp=True,
        ...
        AbstractIPTagableVertex.__init__(
            self, tag, port, address, board_address, strip_sdp=strip_sdp)
    ...
    def generate_data_spec(self, subvertex, placement, sub_graph, graph,
        ...
        self.write_configuration_region(spec, subvertex, tag_info)
    ...
    def write_configuration_region(self, spec, partitioned_vertex, tag_info):
        """ writes the configuration region to the spec

        :param spec: the spec object for the dsg
        :type spec: instance of data_specification.file_data_writer.FileDataWriter
        ...
        :param tag_info: the tag infos object generated by the tag allocator
        :type tag_info: pacman.model.tag_infos.tag-infos.TagInfos
        ...
        #sdp tag
        spec.write_value(data=tag_info.get_tag_for_partitioned_vertex(
            partitioned_vertex.label).tag)
